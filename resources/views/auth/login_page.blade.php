...
<body>
    ...
    <div class="d-flex align-items-center justify-content-center ht-100v">
        ...
        <div class="overlay-body bg-black-6 d-flex align-items-center justify-content-center tx-black">
            <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 rounded-30 bg-white text-center">
                <img src="{{asset('backend/logo-jpa.png')}}" class="wd-200  img-fluid mg-b-20" alt="">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <button type="submit" class="btn btn-teal btn-block" style="">Sign In</button>
