                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="db_host" value="{{$db_host}}" class="form-control"
                        ...
                        <div class="row row-sm">
                                    ...
                                    <div class="form-group  " id="datepicker-date-area">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="date_to" id="date2" value="{{date('Y-m-d')}}"
                                                autocomplete="off" class="datepicker form-control time  mg-r-10" required>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <small class="tx-danger">* Warning !!, This action will remove all sensor data permanently,Be Carefull !</small>
                                </div>
...
<script>
    ...
    function restartGateway() {
        Swal.queue([{
            ...
            showLoaderOnConfirm: true,
            preConfirm: () => {
                return axios.get('http://localhost:3000/restart')
                    .then(function (response) {
